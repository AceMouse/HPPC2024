...
void exchange_ghost_cells(World &world) {
    ...
    MPI_Request request[8]; int tag = 0;
    // MPI_Status stat; 
    ...
    MPI_Isend(&send_left, world.latitude-2, MPI_DOUBLE, world.neighb[0], tag, MPI_COMM_WORLD, &request[0]);
    MPI_Isend(&send_right, world.latitude-2, MPI_DOUBLE, world.neighb[1], tag, MPI_COMM_WORLD, &request[1]);
    MPI_Isend(&send_up, world.longitude-2, MPI_DOUBLE, world.neighb[2], tag, MPI_COMM_WORLD, &request[2]);
    MPI_Isend(&send_down, world.longitude-2, MPI_DOUBLE, world.neighb[3], tag, MPI_COMM_WORLD, &request[3]);
    
    MPI_Irecv(&recv_left, world.latitude-2, MPI_DOUBLE, world.neighb[0], tag, MPI_COMM_WORLD, &request[4]);
    MPI_Irecv(&recv_right, world.latitude-2, MPI_DOUBLE, world.neighb[1], tag, MPI_COMM_WORLD, &request[5]);
    MPI_Irecv(&recv_up, world.longitude-2, MPI_DOUBLE, world.neighb[2], tag, MPI_COMM_WORLD, &request[6]);
    MPI_Irecv(&recv_down, world.longitude-2, MPI_DOUBLE, world.neighb[3], tag, MPI_COMM_WORLD, &request[7]);
